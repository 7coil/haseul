...
const HaSeul = require("../dist").default;
...
describe("HaSeul", function () {
      ...
      describe("abc command", function () {
        ...
        describe('"abc123"', function () {
          ...
          it("output user input matches passed in string", function () {
            sinon.assert.calledWith(
              spy,
              sinon.match.has("userInput", "abc123")
            );
          });
        });
        ...
        describe('"abc 123"', function () {
          ...
          it("output user input matches passed in string", function () {
            sinon.assert.calledWith(
              spy,
              sinon.match.has("userInput", "abc 123")
            );
          });
        });
  ...
  describe("#getDiscordCommandList", function () {
    const router = new HaSeul();
    ...
    const links = router.getDiscordCommandList();
    console.log(links);
  });
});
